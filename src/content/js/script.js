...
jQuery(function($) {
    ...
    $('.sidebar-control .expand').click(function(event) {
        ...
        $(this).closest('.sidebar-left').toggleClass('mini');
    });
    var heightWindow = $( window ).height();
    var heightControlTop = $('.control-top').outerHeight();
    /*custom wrap-control-esr height*/
    $( '.control-esr .wrap-control-esr' ).height(heightWindow - heightControlTop);
    $('.wrap-product .table-product-wrap').height(heightWindow - 50 - heightControlTop);
    /*custom time-line height*/
    $('.wrap-timeline .esr-content-sidebar-timeline').innerHeight(heightWindow - heightControlTop);
    $('.wrap-timeline .wrap-timeline-body').height(heightWindow - 24 - heightControlTop);
